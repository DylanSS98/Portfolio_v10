...
<div class="reveal">
    <div id="competence">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/hardware_mini.jpg" class="d-block w-100">
                        <div class="carousel-caption d-none d-md-block">
                            <h4>Hardware</h4>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/software.jpg" class="d-block w-100">
                        <div class="carousel-caption d-none d-md-block">
                            <h4>Software</h4>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/relation_client_mini.jpg" class="d-block w-100">
                        <div class="carousel-caption d-none d-md-block">
        ...
        <ul>
            ...
            <li>
                <div class="logo_comp">
                    <img src="https://img.icons8.com/color/144/000000/adobe-premiere-pro.png"/>
                </div>
                <p>Premier Pro</p>
            </li>
